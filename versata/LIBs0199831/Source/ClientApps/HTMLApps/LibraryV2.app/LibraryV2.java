...
//{{APP_CLASS_DECL
public class LibraryV2 extends LibraryV2Base
//END_APP_CLASS_DECL}}
{
    // LibraryV2 Class Constructor
	//{{APP_CLASS_CTOR
	public LibraryV2 ()
	//END_APP_CLASS_CTOR}}
    {
		...
		//{{APP_DOACTION
		   ...
		   if ( VSTrace.IS_ON ){
		   	tr = VSTrace.get();	
		     	...
		     	tr.set(VST_SESSION_ID, getSessionIDForTracing()).set(VST_CATEGORY, VST_PLS_ACTION).set(VST_ACTION_NAME,"LibraryV2.doAction");
		}
