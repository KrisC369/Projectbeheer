...
//{{APP_CLASS_DECL
public class LibraryV3 extends LibraryV3Base
//END_APP_CLASS_DECL}}
{
    // LibraryV3 Class Constructor
	//{{APP_CLASS_CTOR
	public LibraryV3 ()
	//END_APP_CLASS_CTOR}}
    {
		...
		//{{APP_DOACTION
		   ...
		   if ( VSTrace.IS_ON ){
		   	tr = VSTrace.get();	
		     	...
		     	tr.set(VST_SESSION_ID, getSessionIDForTracing()).set(VST_CATEGORY, VST_PLS_ACTION).set(VST_ACTION_NAME,"LibraryV3.doAction");
		}
