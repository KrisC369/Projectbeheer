...
public abstract class LibraryV3BaseServlet extends PLSServlet
{
	...
	public static String applicationName = "LibraryV3";
	...
	public String getDefaultFileLocation()
	{
		if (m_strAppDir != null && m_strAppDir.length() > 0)
		    return m_strAppDir + "Source/ClientApps/HTMLApps/" + "LibraryV3.app/";
