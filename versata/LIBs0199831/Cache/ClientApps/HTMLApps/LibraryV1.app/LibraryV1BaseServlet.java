...
public abstract class LibraryV1BaseServlet extends PLSServlet
{
	...
	public static String applicationName = "LibraryV1";
	...
	public String getDefaultFileLocation()
	{
		if (m_strAppDir != null && m_strAppDir.length() > 0)
		    return m_strAppDir + "Source/ClientApps/HTMLApps/" + "LibraryV1.app/";
