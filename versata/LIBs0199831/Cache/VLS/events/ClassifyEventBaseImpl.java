...
public abstract class ClassifyEventBaseImpl extends  DataObject
	
{
	public static Logger logger = Logger.getLogger("LIBs0199831.ClassifyEvent");
	
	public ClassifyEventBaseImpl () {
		super();
		addListeners();
	}
	...
	*/
	...
	static {
		q= new VSQueryDefinition( "ClassifyEvent" );	
		q.setPackageName(deployedFromRepository);
		
		VSMetaColumn c = null;
		VSMetaTable t = new VSMetaTable("ClassifyEvent");
		//{{META_QUERY_COLUMN_CTOR
		c = new VSMetaColumn("PKClassifyEvent", DataConst.BIGINT);	
	...
	//END_META_QUERY_COLUMN_CTOR}}
		q.addTable( t );
		q.populateQCArray();
		VSQueryDefinition qTemp = (VSQueryDefinition)getMetaQuery( "ClassifyEvent",deployedFromRepository ); 
		if ( qTemp == null ) {			
