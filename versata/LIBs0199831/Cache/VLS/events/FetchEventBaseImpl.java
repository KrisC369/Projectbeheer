...
public abstract class FetchEventBaseImpl extends  DataObject
	
{
	public static Logger logger = Logger.getLogger("LIBs0199831.FetchEvent");
	
	public FetchEventBaseImpl () {
		super();
		addListeners();
	}
	...
	*/
	...
	static {
		q= new VSQueryDefinition( "FetchEvent" );	
		q.setPackageName(deployedFromRepository);
		
		VSMetaColumn c = null;
		VSMetaTable t = new VSMetaTable("FetchEvent");
		//{{META_QUERY_COLUMN_CTOR
		c = new VSMetaColumn("PKFetchEvent", DataConst.BIGINT);	
	...
	//END_META_QUERY_COLUMN_CTOR}}
		q.addTable( t );
		q.populateQCArray();
		VSQueryDefinition qTemp = (VSQueryDefinition)getMetaQuery( "FetchEvent",deployedFromRepository ); 
		if ( qTemp == null ) {			
