...
public abstract class LibraryV3Base extends PLSApp implements java.io.Serializable
{
	public static Logger logger = Logger.getLogger("LIBs0199831.LibraryV3");
	...
	{   
		...
		try
		{
			...
			StartPageNav.setTargetName("Display");
